...
{
    public class
        TeamInvitationDeclinedEventHandler : IEventHandler<TeamInvitationDeclinedEvent>
    {
        private readonly ICache _cache;
        private readonly ICacheKey _cacheKey;
        private readonly IMongoCollection<Invitation> _invitationsCollection;

        public TeamInvitationDeclinedEventHandler(ICache cache, ICacheKey cacheKey,
        ...
        public async Task HandleAsync(TeamInvitationDeclinedEvent @event,
