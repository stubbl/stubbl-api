namespace Stubbl.Api.Middleware.StubTester
{
   using System;
   ...
   public class StubTesterMiddleware
   {
      ...
      public StubTesterMiddleware(RequestDelegate next, IOptions<ApiOptions> apiOptions, ICommandDispatcher commandDispatcher,
      ...
      {
         var subdomainMatch = Regex.Match(host.Value, $"^([^\\.]*)\\.{_apiOptions.Host}$");
