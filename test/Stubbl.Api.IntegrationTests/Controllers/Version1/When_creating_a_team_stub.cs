namespace Stubbl.Api.IntegrationTests.Controllers.Version1
{
   ...
   using Core.Events.TeamStubCreated.Version1;
   ...
   public class When_creating_a_team_stub : IntegrationTest<CreateTeamStubResponse>
   {
      private readonly ObjectId _teamId;

      public When_creating_a_team_stub()
